...
//   const mockData = {
//     "/products/phones": phones, // Replace with actual data from your Redux store
//     "/products/notebooks": notebooks // Replace with actual data from your Redux store
//   };
...
// import { fetchNotebooks, fetchPhones } from "../../redux/feature/ProductsSlice";
// import "../../styles/Phones.scss";
...
//   const { phones, notebooks } = useAppSelector((state) => state.products);
...
//                     }`}
//                   >
//                     {currentData.slice(0, 4).map(
//                       (
//                         item // Use slice instead of splice
//                       ) => (
//                         <div key={item.id} className='phones-list-item'>
//                           <CardItem item={item} />
//                         </div>
...
const ProductsComponent = () => {
  ...
  const currentData = path.includes("/phones")
    ? phones
